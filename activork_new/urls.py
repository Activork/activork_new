...
#app urls
    ...
    url(r'^mobile/get_info/$','myapp.views.mobile_get_info',name='mobile_get_info'),
    url(r'^mobile/home_page/$','myapp.views.mobile_home_page',name='mobile_home_page'),
    url(r'^mobile/earlier_home/$','myapp.views.mobile_earlier_home_page',name='mobile_earlier_home_page'),
    ...
    url(r'^mobile/follow_user/$','myapp.views.mobile_follow_user',name='mobile_follow_user'),
    url(r'^mobile/unfollow_user/$','myapp.views.mobile_unfollow_user',name='mobile_unfollow_user'),
    url(r'^mobile/fill_userprofile/$','myapp.views.mobile_fill_userprofile',name='mobile_fill_userprofile'),
